...
export default class Visitor extends PureComponent{
  state = {
    startValue: null,
    endValue: null,
  };
  ...
  componentDidMount(){
    const { dispatch, statistics:{ visitor_data_params:{ line1,line2 } } } = this.props;
    dispatch({
      type:'statistics/fetch_visitor_data',
      payload:{
        ...line1
      },
      params:{
  ...
  render(){
    const { statistics:{ 
      visitor_data:{ line1 }, 
      visitor_data_params:{ line1:line1_params }, 
            ...
            <Spin spinning={loading}>  
                ...
                <div style={{marginTop:24,width:600}}>
                  <Row gutter={16}>
                    ...
                    <Col span={3}>
                      <a href={`/api/stats/visitor/export?${stringify(line1_params)}`}><Button loading={loading} style={{marginTop:3}}>导出</Button></a>
                    </Col>
                  </Row>
                </div>
                <div>
