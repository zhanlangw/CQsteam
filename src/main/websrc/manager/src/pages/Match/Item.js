            ...
            <div key={e}>
                ...
                <FormItem
                    ...
                    {getFieldDecorator(`stages[${i}][endTime]`, {
                        ...
                        <DatePicker disabled showTime disabledDate={this.disabledEndDate}  style={{width:'100%'}} format="YYYY/MM/DD HH:mm:ss" placeholder="请选择材料截止时间"/>
                    )}
                </FormItem>
                <Row gutter={10}>
                    <Col span={8}>
            ...
            <Card>
                <FormItem
                    ...
                    {getFieldDecorator('name', {
                        ...
                        <Input placeholder="请填写类别名称" disabled/>
                    )}
                </FormItem>
                <FormItem
                    {...formProps}
                    ...
                    {getFieldDecorator('abbreviation', {
                        ...
                        <Input placeholder="请填写简称" disabled/>
                    )}
                </FormItem>
                <Row gutter={10}>
                    <Col span={8}>
                    ...
                    <Col span={4}>
                        <FormItem
                            ...
                            {getFieldDecorator('minMember', {
                                ...
                                <InputNumber onBlur={this.handleConfirmBlur} min={1} disabled/>
                            )}
                        </FormItem>
                    </Col>
                    <Col span={4}>
                ...
                <FormItem
                    ...
                    {getFieldDecorator('group', {
                        ...
                        <Checkbox.Group disabled style={{ width: "100%", marginTop:9 }}>
                            <Row>
                ...
                <FormItem
                    ...
                    <div style={{
                            ...
                            <Row style={{marginLeft:-24}}>
                                <Col span={24}><Checkbox disabled checked={checkAll} indeterminate={indeterminate} onChange={this.checkAll} value='*'>全选</Checkbox></Col>
                            </Row>
                            {getFieldDecorator('areaIds', {
                                rules: [{ required: true, message: '省份配置不能为空' }],
                                initialValue:item_area.map(e=>e.id)
                            })(
                                <Checkbox.Group disabled onChange={this.areaIdsChange} style={{ width: "100%", marginTop:-6 }}>
                                    <Row>
                ...
                <FormItem
                    ...
                    {getFieldDecorator('signUpTime', {
                        ...
                        <DatePicker disabled showTime style={{width:'100%'}} format="YYYY/MM/DD HH:mm:ss" placeholder="请选择报名开始时间"/>
                    )}
                </FormItem>
                <FormItem
                    {...formProps}
                    ...
                    {getFieldDecorator('match', {
                        ...
                        <Checkbox.Group disabled onChange={this.onChange} style={{ width: "100%", marginTop:9 }}>
                            <Row>
                ...
                <div style={{textAlign:'center'}}>
                    ...
                    <Button onClick={()=>{router.push('/match/list')}} >返回</Button>
                </div>
            </Card>
          </Spin>
        </Card>
